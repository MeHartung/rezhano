 ...
 * @ORM\Entity()
 */
class Testimonial implements ImageAwareInterface
{
  /**
   * @var int
   *
  ...
  public function getTeaserImage()
  {
    ...
    return new UnprocessedImage('testimonial/teaser', $this->teaser, []);
  }
  ...
  {
    return $this->getId()?sprintf('Отзыв #%s', $this->getId()):'Новый отзыв';
  }
}
