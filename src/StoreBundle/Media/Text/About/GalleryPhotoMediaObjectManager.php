...
namespace StoreBundle\Media\Text\About;

use Accurateweb\MediaBundle\Model\Gallery\MediaObjectManager;
use Accurateweb\MediaBundle\Model\Media\MediaInterface;
use App\Media\Gallery\AboutPhoto\GalleryPhotoRepository;
use Doctrine\ORM\EntityManager;
use App\Media\Gallery\ProductPhoto\ProductPhotoRepository;

class GalleryPhotoMediaObjectManager implements MediaObjectManager
{
  private $em;

  private $repository;

  public function __construct(EntityManager $em, GalleryPhotoRepository $repository)
  {
    $this->em = $em;
