...
class MetaProduct implements MetaInterface, MetaOpenGraphInterface
{
  ...
  public function getMetaTitle ()
  {
    ...
    return $this->product->isBundle() ?
      sprintf('%s — %s — в Интернет-магазине сыроварни «Режано» с доставкой в Екатеринбурге, Реже', $this->product->getName(), mb_strtolower(strip_tags(str_replace(array("r","n"),"",$this->product->getShortDescription()))))
      :
      sprintf('Купите сыр %s — %s — в Интернет-магазине сыроварни «Режано» с доставкой в Екатеринбурге, Реже', $this->product->getName(), mb_strtolower(strip_tags(str_replace(array("r","n"),"",$this->product->getShortDescription()))));
  }
  ...
  public function getMetaDescription ()
  {
    ...
    return $this->product->isBundle() ?
      sprintf('%s. Вы можете заказать доставку товара %s в Интернет-магазине сыроварни «Режано»', strip_tags(str_replace(array("r","n"),"",$this->product->getDescription()), $this->product->getName()))
      :
      sprintf('%s. Вы можете заказать доставку сыра %s в Интернет-магазине сыроварни «Режано»', strip_tags(str_replace(array("r","n"),"",$this->product->getDescription()), $this->product->getName()));
  }
  ...
  public function getMetaKeywords ()
  {
    ...
    $keywords = [
      ...
      'частная сыроварня',
      mb_strtolower(strip_tags(str_replace(array("r","n"),"", $this->product->getShortDescription()))),
