...
class MoySkladBundleImageDataSource extends BaseDataSource
{
  private
  ...
  public function get($from, $to = null, $em = null)
  {
     ...
     *
     * @var EntityList $moySkladBundlesImages
     */
    ...
    try
    {
      $moySkladBundlesImages = Bundle::query($sklad)->getList();
    ...
    if ($moySkladBundlesImages->count() === 0)
    {
      return;
    }
     ...
     */
    foreach ($moySkladBundlesImages->toArray() as $key => $productImage)
    {
