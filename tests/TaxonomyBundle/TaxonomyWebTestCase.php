...
namespace Tests\TaxonomyBundle;
...
class TaxonomyWebTestCase extends FixtureAwareWebTestCase
{
  /** @var Client */
  ...
  {
    $doctrine = $this->application->getKernel()->getContainer()->get('doctrine');
  ...
  protected function schemaCreate()
  {
